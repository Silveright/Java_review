...
//		//index번호 12번 째부터 "man"의 시작 index를 찾는다.
//		int index5 = message.lastIndexOf("man",12);
//		System.out.println("12번 부터 man의 위치는 " +index5);
//		
//		int index6 = message.lastIndexOf("java");
//		System.out.println("java 위치는 " +index6);
//		
